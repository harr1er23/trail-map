...
export const JourneyCard: React.FC<JourneyCardProps> = ({ country, city, date, description, image, loading, onClick }) => {
  return (
    <>
      {!loading ? <Card onClick={() => onClick?.()} withBorder radius="md" p={0} className={classes.card + ' cursor-pointer'}>
        <Image
